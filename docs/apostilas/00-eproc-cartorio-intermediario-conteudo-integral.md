...
▪**Resultado do Último Laudo Médico de Incapacidade**: ainda não utilizado pelo TJSP;
...
AUTOMATIZAÇÃO DE TRAMITAÇÃO PROCESSUAL – REGRAS DE AUTOMATIZAÇÃO – PARTE I
...
AUTOMATIZAÇÃO DE TRAMITAÇÃO PROCESSUAL – REGRAS DE AUTOMATIZAÇÃO – PARTE II
...
informações de que a parte está presa, de que há pedido de justiça gratuita e se trata-se de criança
...
AUTOMATIZAÇÃO DE TRAMITAÇÃO PROCESSUAL – REGRAS DE AUTOMATIZAÇÃO – PARTE
...
AUTOMATIZAÇÃO DE TRAMITAÇÃO PROCESSUAL – DISPONIBILIZAÇÃO E IMPORTAÇÃO DE

GRUPOS DE AUTOMATIZAÇÃO
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**115**</small><small>**Descrição da imagem**: janela “Descrição da Pesquisa Preferencial” preenchida com a descrição da pesquisa,</small><small>destaque à caixa de seleção “Exibir no Painel Inicial” e “Salvar”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**116**</small><small>**Descrição da imagem**: seção “Minutas” contendo a preferência de pesquisa cadastrada, destaque ao ícone</small><small>“Atualizar”.</small>
...
A aula 7 do curso “**eproc****para Cartório****–****Módulo Básico**” apresenta as informações essenciais
...
**Variáveis”**,**“Selecionar Tudo”**(representando por uma página de papel),
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**122**</small>
▪**“Inserir Texto padrão ou TAG” (“Alt” e “T”)**: representando por uma caixa de diálogo
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**123**</small><small>**Descrição da imagem**: destaque a nota de fim de texto destacada no documento minutado e no rodapé da página.</small>
...
▪**“****Renumerar notas de fim de texto****”**: representando por uma lista com os números 1

e 2. O ícone permite a renumeração das notas de fim de texto inseridas;
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**125**</small><small>**Descrição da imagem**: ícones da segunda caixa de ícones da linha inferior do editor de textos.</small>
...
▪**“****Inserir Linha Horizontal****”**: representando por um texto com uma linha em destaque.
...
▪**“****Cor do Plano de Fundo****”**: representando pela letra A dentro de um quadrado. O ícone
...
▪**“****Teclas de atalho****”**: representando por uma sulfite com a borda vermelha. O ícone
...
As aulas sobre minutas do curso “**eproc****para Cartório****–****Módulo Básico**” demonstram a criação de
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**131**</small><small>**Descrição da imagem**: ícones disponíveis do centro da tela referente a minuta.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**136**</small><small>**Descrição da imagem**: preferência de pesquisa inserida na seção “Minutas”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**139**</small><small>**Descrição da imagem**: caixa da opção “selecionada na área de trabalho” desmarcada por não ser necessária a</small><small>assinatura da minuta.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**148**</small><small>**Descrição da imagem**: tela “Relatório Geral” com seleção dos filtros “Situação” e “Situação há mais de (dias)”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**150**</small><small>**Descrição da imagem**: tela “Relatório de Eventos Lançáveis Por Situação Atual Processo”</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**151**</small><small>**Descrição da imagem:**tela “Relatório de processo sem movimentação nos últimos dias”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**153**</small><small>**Descrição da imagem:**destaque para a lista “Acessos de Sessão”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**158**</small><small>**Descrição da imagem**: tela “Bens Associados” com visualização de bem cadastrado.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**161**</small><small>**Descrição da imagem**: tela “Relatório de Bens Associados” da unidade selecionada.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**163**</small><small>**Descrição da imagem**: tela “Bens Apreendidos” com destaque aos ícones da coluna “Ações”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**164**</small><small>**Descrição da imagem**: tela capa do processo com a etiqueta “Possui bem apreendido”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**165**</small><small>**Descrição da imagem**: janela “Justificar Recusa de Transferência”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**168**</small><small>**Descrição da imagem**: quadro “Procuradores pendentes de associação” com destaque ao ícone “Remover item” da</small><small>coluna “Ações” e ao botão “Confirmar Associação”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**169**</small><small>**Descrição da imagem**: seção “Partes do processo e seus procuradores atuais” com destaque às opções de seleção</small><small>para o status da parte na coluna “Ações”.</small>
**Nomear perito**
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**170**</small><small>**Descrição da imagem**: seção “Seleção do perito” com destaque à seleção do campo “Intimar Perito Nomeado”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**171**</small><small>**Descrição da imagem**: campo para anexação de documentos na intimação do perito, com destaque aos botões</small><small>“Digitar Documento” e “Visualizar Minutas do Processo” na barra superior e aos botões “Escolher arquivo” e</small><small>“Confirmar seleção de documentos”.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**173**</small><small>**Descrição da imagem**: seção “Gerenciar Localizadores” com exibição do localizador atual desmarcado e destaque</small><small>para o novo localizador.</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**175**</small><small>**Descrição da imagem**: seção “Gerenciar Localizadores” com destaque ao localizador atual a ser removido</small><small>(“Requisitar INSS – Requisitar INSS”) e ao novo localizador (“Ag. Resposta INSS – Ag. Resposta INSS”).</small>
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**176**</small><small>**Descrição da imagem**: tela “Partes e Representantes” do processo com destaque ao campo “AGÊNCIA DA</small><small>PREVIDÊNCIA SOCIAL” preenchido.</small>
O evento referente à requisição poderá ser visualizado na tabela de eventos.
<small>**Descrição da imagem**: tabela de eventos, com visualização do evento relativo à requisição.</small>
...
O sistema SAJ é estruturado com o conceito do processo digital, utilizando a pasta digital como

elemento essencial. Já o eproc possui o conceito do processo eletrônico, o qual é conduzido pelos

eventos, permitindo uma série de facilidades no dia a dia.

Essa diferença faz com que, em casos de migração de processos do SAJ para o eproc, possa ocorrer

desordenação de documentos, havendo a necessidade do saneamento.
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**178**</small><small>**Descrição da imagem**: tela “Reordenar Documentos em Processo Migrado”.</small>
...
Com exceção das suspensões de prazo afetas ao foro, comarca ou ao âmbito geral no TJSP, os

gestores das unidades judiciais poderão cadastrar suspensões de prazos específicas e individuais

acessando a página “Suspensões de Prazo”, dentro da categoria “Gerenciamento de Feriados e

Suspensões” do menu lateral.
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**182**</small><small>**Descrição da imagem**: certidão em formato PDF gerada pelo eproc referente a parada do sistema.</small>
Observa-se, por fim, que a indisponibilidade do sistema previstas nos artigos 1. 205 a 1. 205-D das

Normas de Serviço da Corregedoria Geral da Justiça - NSCGJ afetará a contagem de prazos

processuais e será objeto de intervenção automática pelo sistema de controle.
...
**EPROC PARA CARTÓRIO****–****MÓDULO INTERMEDIÁRIO****|**Conteúdo integral do curso
<small>**183**</small><small>**Descrição da imagem**: destaque ao botão “Alterar” e aos campos disponíveis para alteração.</small>
